...
class CollectionViewTestCase(ElvisTestSetup, APITestCase):
    ...
    def test_post_create_piece_create_movement(self):
        ...
        self.assertItemsEqual(piece.collections.all(), mov.collections.all())
        self.assertEqual(piece.number_of_voices, mov.number_of_voices)
        self.assertItemsEqual(piece.genres.all(), mov.genres.all())
        self.assertItemsEqual(piece.locations.all(), mov.locations.all())
        self.assertItemsEqual(piece.languages.all(), mov.languages.all())
        self.assertItemsEqual(piece.sources.all(), mov.sources.all())
        self.assertItemsEqual(piece.instruments_voices.all(), mov.instruments_voices.all())
        self.assertEqual(piece.religiosity, mov.religiosity)
        self.assertEqual(piece.vocalization, mov.vocalization)
        self.assertItemsEqual(piece.tags.all(), mov.tags.all())
        self.client.logout()
