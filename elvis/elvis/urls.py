...
urlpatterns += format_suffix_patterns(
    patterns('',
        ...
        url(r'^account/password_change/$', auth_views.password_change, name='password_change'),
        url(r'^account/password_change_done/$', auth_views.password_change_done, name='password_change_done'),
