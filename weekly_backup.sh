...
rsync -r --delete --link-dest=/users/AlexPar/ELVISDB_BACKUP/backup.1 /srv/webapps/elvis-database-backups/backup.0/ AlexPar@132.206.14.118:~/ELVISDB_BACKUP/backup.0/
