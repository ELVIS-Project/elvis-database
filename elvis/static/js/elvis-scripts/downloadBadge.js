...
function create_download_badge(item_type, item_id, DOM_id)
{
    ...
    $DOM.append("<form class='recursive-patch-download-form' action='/downloads/' method='post'>" +
        "<button type='button' class='btn btn-mini btn-success' data-container='body' data-toggle='tooltip' data-placement='top' title='Add to Cart.' ><span class='glyphicon glyphicon-plus'> </span> </button>" +
